...
class ActionsControllerTest < ActionController::TestCase
  ...
  test "should create action" do
    assert_difference('Action.count') do
      post :create, action: { description: @action.description, duedate: @action.duedate, title: @action.title }
    end
  ...
  test "should update action" do
    put :update, id: @action, action: { description: @action.description, duedate: @action.duedate, title: @action.title }
    assert_redirected_to action_path(assigns(:action))
  end
